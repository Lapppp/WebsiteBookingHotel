...
export const chartExample2 = {
  options: {
    responsive: true,
    maintainAspectRatio: false, // Allow the chart to fill the container's width
    scale: {
      ticks: {
        beginAtZero: true,
      },
  ...
  data: {
    labels: ["Cleanliness", "Service", "Location", "Value", "Amenities"],
    datasets: [
      {
        label: "Reviews",
        data: [85, 72, 78, 75, 77],
        backgroundColor: colors.theme.warning + "33",
